...
case $EXPERIMENT in
	...
	1.2)
		bash run_all.sh ../src ../src/topologies/topzoo/ ../src/topologies/graphs_v2.txt ../out/dynamic_add_last_1.2_run$RUN run_dynamic.py add_last 15 15 1 1 $BASHFILE;;
	10) #run bdd, baseline
	...
	10.2) 
		bash run_all.sh ../src ../src/topologies/topzoo/ ../src/topologies/wavelengths.txt ../out/bdd_baseline_demands_effect_run$RUN run_bdd.py baseline 10 10 1 1 $BASHFILE;;
