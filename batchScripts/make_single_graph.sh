...
case $graph in
	...
	1)
		python3 convert_to_csv.py -dir ../../out/$out -x 5 -savedest csv/one_path.csv -yfill 3600;
        python3 AAU_scatter.py -d csv/one_path.csv -xlabel Demands -ylabel "Run time (s)" -agg 0 -x 5 -savedest new_graphs/one_path -agg_func median;;
	6)
