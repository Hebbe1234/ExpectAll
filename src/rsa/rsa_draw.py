...
def draw_assignment_path_vars(assignment: dict[str, bool], base, paths: list[list], unique_channels, topology: MultiDiGraph, file_path="../assignedGraphs/assignedRSA", failover = False):
    ...
    for demand_id in base.demand_vars.keys():
        path_index = base.d_to_paths[demand_id][counting_path_number[str(demand_id)]]
        path = paths[path_index]
        channel = base.demand_to_channels[demand_id][demand_to_chosen_channel[str(demand_id)]]
