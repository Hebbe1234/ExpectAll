...
bdd_source_dir = "../../out/Reproduceability/EXPERIMENT_FAILOVER_RUN_FIX_1D_NOCHANGE"
MIP_source_dir = "../../out/Reproduceability/EXPERIMENT_FAILOVER_MIP_PRESERVING_RUN_1"
# Define folder and file name variables
topologies = ["dt","kanto"]
"no_change_query_times"
whatToShow = "all_times"
whatToShow2 = ["no_change_query_times"]
