...
if __name__ == "__main__":
   # G = topology.get_nx_graph("topologies/topzoo/Ai3.gml")
    ...
    print(demands)
    p = AllRightBuilder(G, demands, 2, slots=150).dynamic_vars().path_type(AllRightBuilder.PathType.DISJOINT).fixed_channels(2,2,"myDirFast2", False, ChannelGenerator.JAPANMIP).limited().construct()
