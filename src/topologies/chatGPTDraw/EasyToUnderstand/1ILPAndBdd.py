...
source_dirs = ["EXPERIMENT_FAILOVER_MIP_FINAL_RUN_1", "EXPERIMENT_FAILOVER_MIP_PRESERVING_RUN_1"]


bdd_source_dir = "EXPERIMENT_FAILOVER_RUN_FIX_1D_NOCHANGE"
MIP_source_dir = "EXPERIMENT_FAILOVER_MIP_FINAL_RUN_1"
# Define folder and file name variables
topologies = ["dt","kanto"]
"no_change_query_times"
whatToShow = "all_times"
whatToShow2 = ["all_times"]
for whatToShow in whatToShow2:
    for topologyName in topologies: 
        ...
        for i in range(1, 6):
            ...
            # topologyName = "dt"
            # topologyName = "kanto"
            folder_name1 = bdd_source_dir+"_" + topologyName + "Ands"
            folder_name2 = bdd_source_dir+"_" + topologyName + "EdgeTop"
            folder_name3 = MIP_source_dir+"_"+topologyName 
            edgeFail = i
            ...
            data_values3 = [item["all_times"][0] for item in data3]
            ...
            output_folder = "ILPvsBDD_"+whatToShow+"_"+topologyName
